...
//有赞
open class YouZanWebFragment: BaseFragment<FragmentHomeyouzanBinding>(), OnKeyBackHandle {
    companion object
    {
        const val WebUrl="WebUrl"
        fun newInstance(url:String,showTitle:Boolean=true,title:String=""):YouZanWebFragment
        {
            return newInstance(url,showTitle,title,YouZanWebFragment::class.java)
        }

        fun newInstance(url:String,showTitle:Boolean=true,title:String="",clazz:Class<out YouZanWebFragment>):YouZanWebFragment
        {
